...
Future showPopupAddUser(BuildContext context, int workId) {
  late AddWorkLogic addWork;
  addWork = AddWorkLogic(context: context);
  addWork.getlstUserWork();
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: TextField(
                              ...
                              onChanged: (text) {
                                ...
                                logic.setLstHienThi(
                                    logic.controllerSearch.text.toLowerCase());
                              },
                              maxLines: 1,
                          ...
                          Selector<AddWorkLogic, List<UserDemo>?>(
                              selector: (_, state) =>
