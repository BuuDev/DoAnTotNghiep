...
Future showPopupAddWork(BuildContext context) {
  late AddWorkLogic addWork;
  addWork = context.read<AddWorkLogic>();
  Widget Button(String textButton) {
    return SizedBox(
      ...
      child: TextButton(
        ...
        onPressed: () {
          PopupComfirm(
                  context, "Bạn muốn thêm danh sách thành viên này?", (() {}))
              .then((value) {
            if (value == true) {
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Visibility(
                            visible: !logic.checkFocus,
                            child: logic.lstSearchUser!.isEmpty
                                ? Padding(
                                    ...
                                    child: Text(
                                        ...
                                        style: TextStyle(
                                            color: logic.lstAddUser.isNotEmpty
                                                ? AppColors.primary
                                                : AppColors.red,
                                            fontSize: 16,
                                            fontWeight: FontWeight.w600)),
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: ((context, index) {
                                  return Column(children: [
                                    ...
                                    Text(logic.lstAddUser[index].name,
                                        style: TextStyle(
